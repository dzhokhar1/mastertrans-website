...
@media(max-width:760px){.vz-logo>.vz-icon,.vz-logo .mt-logo-lockup{width:190px!important;height:54px!important}.vz-logo .mt-logo-lockup>img{width:58px!important;height:44px!important}.mt-logo-copy b{font-size:17px}.mt-logo-copy small{font-size:8px}.mt-exact-radio{gap:10px;margin-bottom:15px}.vz-calculator-main-price{margin-top:12px}.mt-city-modal-inner{padding:28px 20px 50px}.mt-city-modal-close{right:12px;top:18px}.mt-city-modal-title{margin-bottom:24px;padding-right:44px}.mt-city-list{grid-template-columns:repeat(2,minmax(120px,1fr));gap:18px 20px}}
</style>'''
