...
html = re.sub(r'(?P<attribute>srcset=["\'])/', r'\g<attribute>', html)
...
@media(max-width:760px){.vz-logo>.vz-icon,.vz-logo .mt-logo-lockup{width:190px!important;height:54px!important}.vz-logo .mt-logo-lockup>img{width:58px!important;height:44px!important}.mt-logo-copy b{font-size:17px}.mt-logo-copy small{font-size:8px}.mt-exact-radio{gap:10px;margin-bottom:15px}.vz-calculator-main-price{margin-top:12px}}
</style>'''
