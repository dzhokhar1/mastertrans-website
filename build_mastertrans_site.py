...
.public-header-menu-collapse-item{position:relative}.public-header-menu-collapse-item-title{align-items:center;display:flex;gap:8px}.mt-menu-chevron{border-bottom:1.5px solid currentColor;border-right:1.5px solid currentColor;display:inline-block;height:7px;margin-top:-4px;transform:rotate(45deg);transition:transform .18s ease;width:7px}.public-header-menu-collapse-item:hover .mt-menu-chevron,.public-header-menu-collapse-item.is-open .mt-menu-chevron{margin-top:4px;transform:rotate(225deg)}.public-header-menu-collapse-item-content{background:var(--white)!important;border:1px solid var(--border-gray);border-radius:0 0 8px 8px;border-top:3px solid var(--primary);box-shadow:var(--pub-gray-box-shadow);left:0!important;max-width:340px;min-width:230px;padding:15px 18px!important;position:absolute!important;top:100%!important;width:max-content!important;z-index:1200!important}.public-header-menu-collapse-item-links{display:flex!important;flex-direction:column;gap:11px;width:auto!important}.public-header-menu-collapse-item-links a{line-height:20px;white-space:nowrap}.public-header-menu-collapse-ground{display:none!important}
...
.public-footer-contacts{min-width:0}.public-footer-contacts-actions{max-width:100%;overflow-wrap:anywhere;word-break:break-word}.mt-footer-heading{align-items:center;color:#c9c9c9;display:flex;font-size:13px;font-weight:600;gap:8px;margin-bottom:16px;text-transform:uppercase}.mt-footer-heading .mdi{color:var(--primary);font-size:18px}.mt-footer-socials{display:flex;flex-wrap:wrap;gap:12px}.mt-footer-socials a{align-items:center;border:1px solid #707070;border-radius:5px;color:#fff;display:flex;gap:8px;padding:8px 11px;text-decoration:none}.mt-footer-socials a:hover{border-color:var(--primary);color:var(--primary)}.mt-footer-icon{display:block;flex:0 0 auto;height:20px!important;object-fit:contain;width:20px!important}.mt-footer-icon-purple{filter:var(--primary-filter)}.mt-footer-contact{align-items:center;color:#fff!important;display:flex;gap:10px;justify-content:flex-end;text-decoration:none}.mt-footer-contact .mdi{color:var(--primary);font-size:21px;flex:0 0 auto}.mt-footer-email{font-size:14px;margin-top:18px;overflow-wrap:anywhere}.mt-footer-location{align-items:center;color:#fff;display:flex;gap:8px;margin-bottom:22px;text-decoration:none}.mt-footer-location .mdi{color:var(--primary);font-size:20px}
...
@media(max-width:760px){.public-header .vz-logo>.vz-icon,.public-header .vz-logo .mt-logo-lockup{width:170px!important;height:44px!important}.public-header .vz-logo .mt-logo-lockup{gap:8px}.public-header .vz-logo .mt-logo-lockup>img{width:50px!important;height:38px!important}.public-header .mt-logo-copy b{font-size:16px}.public-header .mt-logo-copy small{font-size:7.5px;letter-spacing:1.5px;margin-top:5px}.mt-city-modal-inner{padding:28px 20px 50px}.mt-city-modal-close{right:12px;top:18px}.mt-city-modal-title{margin-bottom:24px;padding-right:44px}.mt-city-list{gap:18px 20px;grid-template-columns:repeat(2,minmax(120px,1fr))}.groupage-cargo-props{flex-direction:column}.groupage-cargo-props-wrapper{margin-right:0!important}.groupage-cargo-props>.public-card-info{margin-top:25px;width:100%}.groupage-cargo-props>.public-card-info .public-card-info-wrapper,.groupage-cargo-props>.public-card-info .public-card-info-img{width:100%}.mt-page-section{margin:45px 0}.mt-content-grid,.mt-city-cards,.mt-price-links,.mt-branch-layout{grid-template-columns:1fr}.mt-content-card{padding:20px}.mt-content-grid .public-service-links-grid-item{min-height:0}.mt-data-table th,.mt-data-table td{padding:11px 12px}.mt-footer-contact{justify-content:flex-start}}
</style>"""
...
def common_header(prefix: str) -> str:
    ...
    for label,path,subitems in items:
        ...
        desktop.append(f'<div class="public-header-menu-collapse-item"><div class="public-header-menu-collapse-item-title"><a href="{prefix}{path}/index.html">{label}</a><span class="mt-menu-chevron" aria-hidden="true"></span></div><div class="public-header-menu-collapse-item-content" style="display:none"><div class="public-header-menu-collapse-item-links">{links}</div></div></div>')
    return (
...
def common_footer(prefix: str) -> str:
    ...
    return f'''<div class="public-footer-main flex flex-space-between">
      <div class="public-footer-info"><div><a href="{prefix}index.html" class="vz-logo text-decoration-none"><div class="vz-icon mdi" style="font-size:158px;line-height:158px;"><span class="mt-logo-lockup" itemprop="logo"><img src="{prefix}svg/mastertrans-source.svg" alt="Master Транс"><span class="mt-logo-copy"><b>Master Транс</b><small>Логистика</small></span></span></div></a></div><div class="public-footer-title mt-30">Грузоперевозки по России</div><div class="mt-footer-socials mt-20"><a href="https://wa.me/79691917777"><img class="mt-footer-icon mt-footer-icon-purple" src="{prefix}svg/phone-in-talk.svg" alt=""><span>WhatsApp</span></a><a href="https://t.me/mastertrans_tk"><img class="mt-footer-icon" src="{prefix}svg/telegram.svg" alt=""><span>Telegram</span></a></div></div>
      <div class="public-footer-menu flex flex-space-around"><div class="public-footer-menu-data"><div class="mt-footer-heading"><span class="mdi mdi-menu"></span><span>Разделы</span></div>{nav}</div><div class="public-footer-menu-data"><div class="mt-footer-heading"><span class="mdi mdi-map-marker"></span><span>Филиалы</span></div><a href="{prefix}address/moskva/index.html" class="public-footer-menu-link">Москва</a><a href="{prefix}address/grozny/index.html" class="public-footer-menu-link">Грозный</a><a href="{prefix}address/hasavyurt/index.html" class="public-footer-menu-link">Хасавюрт</a><a href="{prefix}address/mahachkala/index.html" class="public-footer-menu-link">Махачкала</a><a href="{prefix}address/rostov-na-donu/index.html" class="public-footer-menu-link">Ростов-на-Дону</a></div></div>
      <div class="public-footer-contacts"><div class="mt-footer-heading"><span class="mdi mdi-phone"></span><span>Связаться с нами</span></div><a href="tel:+74953749177" class="public-footer-contacts-phone mt-footer-contact"><span class="mdi mdi-phone"></span><span>+7 (495) 374-91-77</span></a><a href="{prefix}address/index.html" class="vz-button white link big public-footer-contacts-button"><span class="vz-button-title">Контакты</span></a><a href="mailto:mastertransmsk@mail.ru" class="mt-footer-contact mt-footer-email"><img class="mt-footer-icon mt-footer-icon-purple" src="{prefix}svg/mail.svg" alt=""><span>mastertransmsk@mail.ru</span></a></div>
    </div>'''
...
def clean_shell(text: str, prefix: str, page_title: str) -> str:
    ...
    # Keep inlined CSS assets relative to the current generated page. Absolute
    # paths break when the site is hosted below a GitHub Pages project prefix.
    for asset_dir in ("fonts", "images", "svg"):
        text=text.replace(f"url(/{asset_dir}/", f"url({prefix}{asset_dir}/")
