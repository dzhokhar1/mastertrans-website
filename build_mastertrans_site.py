...
def common_footer(prefix: str) -> str:
    ...
    return f'''<div class="public-footer-main flex flex-space-between">
      <div class="public-footer-info"><div><a href="{prefix}index.html" class="vz-logo text-decoration-none"><div class="vz-icon mdi" style="font-size:158px;line-height:158px;"><span class="mt-logo-lockup" itemprop="logo"><img src="{prefix}svg/mastertrans-source.svg" alt="Master Транс"><span class="mt-logo-copy"><b>Master Транс</b><small>Логистика</small></span></span></div></a></div><div class="public-footer-title mt-30">Грузоперевозки по России</div><div class="mt-footer-socials mt-20"><a href="https://wa.me/79691917777"><img class="mt-footer-icon" src="{prefix}svg/whatsapp.svg" alt=""><span>WhatsApp</span></a><a href="https://t.me/mastertrans_tk"><img class="mt-footer-icon" src="{prefix}svg/telegram.svg" alt=""><span>Telegram</span></a></div></div>
      ...
      <div class="public-footer-contacts"><div class="mt-footer-heading"><span class="mdi mdi-phone"></span><span>Связаться с нами</span></div><a href="tel:+74953749177" class="public-footer-contacts-phone mt-footer-contact"><span class="mdi mdi-phone"></span><span>+7 (495) 374-91-77</span></a><a href="mailto:mastertransmsk@mail.ru" class="mt-footer-contact mt-footer-email"><img class="mt-footer-icon mt-footer-icon-purple" src="{prefix}svg/mail.svg" alt=""><span>mastertransmsk@mail.ru</span></a></div>
    </div>'''
